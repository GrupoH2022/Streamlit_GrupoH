...
def app():
    ...
    start = st.date_input('Start Train' , value=pd.to_datetime('2006-01-01'))
    ...
    user_input = st.text_input('Introducir cotización bursátil' , 'GLU')
    ...
    st.subheader('Datos del 2006 al 2022') 
    st.write(df.head())
